  ...
  return (
    <>
      <div className="h-dvh">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#ffb6b6" fillOpacity="1" d="M0,160L40,160C80,160,160,160,240,149.3C320,139,400,117,480,138.7C560,160,640,224,720,234.7C800,245,880,203,960,181.3C1040,160,1120,160,1200,160C1280,160,1360,160,1400,160L1440,160L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path></svg>
      </div>
    </>
  );
};
